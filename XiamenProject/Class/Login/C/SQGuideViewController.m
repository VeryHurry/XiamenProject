...
- (void)createScrollView
{
    ...
    if (IPHONE_X) {
        _imageScrollView.frame = CGRectMake(0, 120*KScale, K_Screen_width, K_Screen_height-120*KScale);
        _imageScrollView.contentSize = CGSizeMake(K_Screen_width *self.imageArray.count, K_Screen_height-120*KScale);
    }
    else
    {
...
- (void)createCancelButton
{
    ...
    _cancelButton.frame = CGRectMake(0, K_Screen_height-80, K_Screen_width, 80);
