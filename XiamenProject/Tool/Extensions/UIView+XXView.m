...
- (void)xx_cornerRadiusLeft:(CGFloat)c
{
    [self xx_cornerRadius:c RectCorner:UIRectCornerTopLeft|UIRectCornerBottomLeft];
}
- (void)xx_cornerRadiusTop:(CGFloat)c
{
    [self xx_cornerRadius:c RectCorner:UIRectCornerTopRight|UIRectCornerTopLeft];
}
- (void)xx_cornerRadiusRight:(CGFloat)c
{
    [self xx_cornerRadius:c RectCorner:UIRectCornerTopRight|UIRectCornerBottomRight];
}
- (void)xx_cornerRadiusBottom:(CGFloat)c
{
    [self xx_cornerRadius:c RectCorner:UIRectCornerBottomRight|UIRectCornerBottomLeft];
}
