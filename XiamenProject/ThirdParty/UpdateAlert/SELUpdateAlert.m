 ...
 */
+ (void)showUpdateAlertWithVersion:(NSString *)version Descriptions:(NSArray *)descriptions level:(NSString *)level
{
    ...
    NSLog(@"====%@",description);
    SELUpdateAlert *updateAlert = [[SELUpdateAlert alloc]initVersion:version description:description level:level];
 ...
 */
+ (void)showUpdateAlertWithVersion:(NSString *)version Description:(NSString *)description level:(NSString *)level
{
    SELUpdateAlert *updateAlert = [[SELUpdateAlert alloc]initVersion:version description:description level:level];
    [[UIApplication sharedApplication].delegate.window addSubview:updateAlert];
}

- (instancetype)initVersion:(NSString *)version description:(NSString *)description level:(NSString *)level
{
    self = [super init];
    if (self) {
...
- (void)cancelAction
{
//    [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"close"];
    [self dismissAlert];
}
